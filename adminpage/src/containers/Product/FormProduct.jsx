    ...
    const formik = useFormik({
        ...
        onSubmit: (values, actions) => {
            ...
            setTimeout(() => {
                ...
                (!productId) ? postProduct(formData) : putProduct(formData)
                ...
                <form onSubmit={formik.handleSubmit}>
                    <Container>
                        <InputGroup>
                            ...
                            <Input name='productId' value={formik?.values?.productId} onChange={formik.handleChange} placeholder="ProductId" />
                        </InputGroup>
                        <br />
                        <InputGroup>
                            <InputGroupAddon addonType="prepend">
                        ...
                        <InputGroup>
                            ...
                            <Input name='rating' type='number' value={formik?.values?.rating} onChange={formik.handleChange} placeholder="Rating" />
                        </InputGroup>
                        <br/>
                        <InputGroup>
                            <InputGroupAddon addonType="prepend">
                        ...
                        <InputGroupAddon addonType="prepend">
                            ...
                            <Input name='imageUrl' value={formik?.values?.imageUrl} onChange={formik.handleChange} placeholder="Image" />
                        </InputGroup>
                        {/* <InputGroup>
